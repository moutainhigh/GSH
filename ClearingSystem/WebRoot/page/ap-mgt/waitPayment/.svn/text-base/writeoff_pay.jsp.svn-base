...
<div class="easyui-layout" data-options="fit:true">
			...
			<table>
				...
				<tr>
					...
					<td><input id="fundAccount" name="fundAccount" class="easyui-combogrid" data-options="valueField: 'code',    
									        ...
									        onChange:window.apmgt.waitPayment.writeoffPay.fundAccountOnChange,
									        columns:[[    
				...
				<tr class="hl trhidden">
					<th>银行汇率</th>
					<td><input id="bankRate" name="bankRate" class="easyui-numberbox" value="1" data-options="precision:2,required:true,novalidate:true,onChange:window.apmgt.waitPayment.writeoffPay.bankRateOnChange" /></td>
				</tr>
				<tr class="hl trhidden">
					<th>汇兑损益</th>
	...
	<div data-options="region:'center',border:false,height:'auto'" style="border-left:solid 1px #ccc;">
		<table id="dtgd_payable_detail" class="easyui-datagrid" data-options="fit:true,
						  ...
						  border:false,
						  fitColumns:true,
						  onClickRow:window.apmgt.waitPayment.writeoffPay.onClickRow">
			<thead>
				<tr>
					...
					<th data-options="field:'payAmount',width:130,formatter:window.apmgt.waitPayment.amountFormatter,editor:{type:'numberbox',options:{validType:['amount[\'dtgd_payable_detail\']'],required:true,precision:2,onChange:window.apmgt.waitPayment.writeoffPay.payAmountOnChange}}">本次付款金额</th>
