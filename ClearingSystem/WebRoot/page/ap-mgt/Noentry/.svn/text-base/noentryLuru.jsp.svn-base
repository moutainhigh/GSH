<%@ page pageEncoding="UTF-8"%>
    ...
    <div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'west',border:false"  style="width:265px;padding:9px; overflow: hidden;">
			<form id="apmgt_noentery_noenteryLuru_form" method="post">
				<table>
					<tr>
					...
					<tr>
						...
						<td colspan="2">
							<select id="voucherType" name="voucherType" onchange="window.apmgt.noentery.gaibian()">
		...
		<a href="#" class="easyui-linkbutton" iconCls="bicon-asterisk" plain="true" id="noenteryLuruAdd">添加</a>
		<a href="#" class="easyui-linkbutton" iconCls="bicon-remove" plain="true" id="noenteryLuruDelete">删除</a>
		<table id="noenteryLuru_datagrid" class="easyui-datagrid" data-options="fit:true,
						  rownumbers:true,
						  singleSelect:true,
						  border:false,
						  fitColumns:true,
						 onClickRow:window.apmgt.noentery.onClickRow">
			<thead>
				<tr>
					<th data-options="field:'invoiceNo',width:90,editor:{type:'validatebox',options:{validType:['invoiceNo'],required:true}}">发票号</th>
					<th data-options="field:'invoiceMoney',width:90,editor:{type:'numberbox',options:{validType:['realAmount'],required:true,precision:2,onChange:invoiceMoneyOnChange}}">发票金额</th>
