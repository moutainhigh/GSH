...
<!-- External JS -->
    <div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center',border:false" style="overflow: hidden;">
			<table id="openAccountToreview_dg" class="easyui-datagrid" data-options="
					width : 540 ,
				    height : 275,
				    pagination:true,
				    showFooter:true,
			...
			<thead>
				<tr>
					...
					<th data-options="field:'payAmount',width:120,align:'right',formatter:window.account.accountToreview.amountFormatter">金额</th>
					<th data-options="field:'currencyType',width:100,hidden:true">货币</th>
					<th data-options="field:'theOperator',width:100">操作人</th>
				</tr>
			</thead>
		</table>
		<div data-options="region:'south'" style="height:70px;" id="sum_footer1"></div>
		</div>
	</div>
</body>
</html>
